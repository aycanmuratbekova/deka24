...
urlpatterns = [
    ...
    path('create/service/order/', views.CreateOrderAPIView.as_view()),
    path('create/delivery/order/', views.CreateOrderAPIView.as_view()),
    path('create/pickup/order/', views.CreateOrderAPIView.as_view()),

    path('edit/order/<int:pk>/', views.CreateOrderAPIView.as_view()),
    path('add/product/order/<int:pk>/', views.CreateOrderAPIView.as_view()),
    path('add/product/order/<int:pk>/', views.CreateOrderAPIView.as_view()),
    path('list/order/', views.OrderListView.as_view()),
    path('detail/order/<int:pk>/', views.CreateOrderAPIView.as_view()),
